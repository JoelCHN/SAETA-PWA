...
<>
    ...
    <div className='w-full pt-10 pb-5 rounded-t-full grid p-2 gap-4 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3'>
        ...
        <div className='w-full h-full flex justify-center items-center'>
            <Image src="/icons/Ban.png" alt="Ban" width={160} height={160}
                className="object-contain max-h-full sm:w-32 sm:h-32" priority />
        </div>
        </Link>
        ...
        <div className='w-full h-full flex justify-center items-center'>
            <Image src="/icons/Camionl.png" alt="Camión liguero" width={160} height={160}
                className="object-contain max-h-full" priority />
        </div>
        </Link>
        ...
        <div className='w-full h-full flex justify-center items-center'>
            <Image src="/icons/Camion.png" alt="Camión" width={160} height={160} className="object-contain max-h-full"
                priority />
        </div>
        </Link>
