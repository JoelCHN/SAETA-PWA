...
<>
    ...
    <section className='flex flex-col gap-8 md:flex-row md:gap-4'>
        <a href="/cities_routes/vehicle" className="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-100">
