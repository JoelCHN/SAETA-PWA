...
import BtonInstall from "../ui/BtnInstall";
      ...
      <footer>
          <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
              <div className="sm:flex sm:items-center sm:justify-between">
                  ...
                  <ul className="flex flex-wrap items-center mb-6 text-sm font-medium text-gray-500 sm:mb-0 sm:mt-2">
                      {/* bton para instalar aplicación */}
                        <BtonInstall/>
                  </ul>
              </div>
